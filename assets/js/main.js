var slideImage = document.querySelector(".carousel1");
firstImage = slideImage.querySelectorAll(".carouselimg")[0];
...
arrowIcons.forEach(icon => {
    icon.addEventListener("click", () => {
        ...
        slideImage.scrollLeft += icon.id == "left" ? -firstImageWidth : firstImageWidth;
...
const dragging = (e) => {
    ...
    e.preventDefault();
    isDragging = true;
    slideImage.classList.add("dragging");
...
const dragStop = () => {
    isDragStart = false;
    slideImage.classList.remove("dragging");
